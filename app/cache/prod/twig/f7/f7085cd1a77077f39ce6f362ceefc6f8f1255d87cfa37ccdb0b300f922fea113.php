...
class __TwigTemplate_1175cd0808c377b0f4880498ecbfd73255c2e715a95111265018f7b9dc3b5f2b extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 38
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "@Twig/Exception/exception.html.twig", 38)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? null)));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 64
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "@Twig/Exception/exception.html.twig", 64)->display(array("logs" => $this->getAttribute(($context["logger"] ?? null), "logs", array())));
            // line 65
            echo "        </div>
    </div>
";
...
";
        // line 89
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "@Twig/Exception/exception.html.twig", 89)->display(array("exception" => ($context["exception"] ?? null)));
        // line 90
        echo "
...
";
    ...
    {
        return new Twig_Source("", "@Twig/Exception/exception.html.twig", "C:\\wamp\\www\\my_project_web\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle\\Resources\\views\\Exception\\exception.html.twig");
    }
}
